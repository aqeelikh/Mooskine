...
extension NoteDetailsViewController {
    ...
    @IBAction func redTapped(sender: Any) {
        ...
        newText.addAttributes(attribute, range: textView.selectedRange)
    ...
    @IBAction func cowTapped(sender: Any) {
        ...
        backgroundContext.perform {
            let backgoundNote = backgroundContext.object(with: noteID) as! Note
            ...
            sleep(5)
            backgoundNote.attributedText = newText
...
extension NoteDetailsViewController {
    ...
    func addSaveNotificationObserver() {
        removeSaveNotificationObserver()
        saveObserverToken = NotificationCenter.default.addObserver(forName: .NSManagedObjectContextObjectsDidChange, object: dataController.viewContext, queue: nil, using: handleSaveNotefication(notification:))
    }
    ...
    func handleSaveNotefication(notification:Notification){
